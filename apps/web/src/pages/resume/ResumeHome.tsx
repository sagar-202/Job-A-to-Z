...
const ResumeHome = () => {
    return (
        <div className="min-h-screen bg-background flex flex-col">
            <main className="flex-1 flex flex-col items-center justify-start pt-16 p-6 text-center animate-in fade-in duration-700">
                <div className="w-full max-w-5xl space-y-8">
                    {/* Hero Section */}
                    <div className="space-y-4 pb-6 border-b">
                        <div className="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent bg-primary/10 text-primary hover:bg-primary/20 mb-3">
                            <Sparkles className="mr-1 h-3 w-3" />
                            AI-Powered Platform
                        </div>
                        <h1 className="text-4xl md:text-6xl font-serif font-bold tracking-tight text-balance text-foreground">
                            AI Career <br />
                            <span className="text-primary">Intelligence Platform</span>
                        </h1>
                        <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                            A unified ecosystem to build your resume, prepare for placements, and track job applications.
                        </p>
                    </div>

                    {/* Resume Builder Section */}
                    <div className="space-y-3">
                        <h2 className="text-3xl font-serif font-bold tracking-tight">Resume Builder</h2>
                    ...
                    <div className="pt-10 grid grid-cols-1 md:grid-cols-3 gap-8 text-left max-w-4xl mx-auto">
